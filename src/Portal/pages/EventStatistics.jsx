    ...
    return (
        <div style={{ maxWidth: '1400px', margin: '0 auto', paddingBottom: '2rem', fontFamily: 'Inter, sans-serif' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
                <div>
                    <h1 style={{ fontSize: '1.8rem', fontWeight: '800', margin: 0, color: '#ffffff' }}>Event Statistics & Analytics</h1>
                ...
                <>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '4rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '1.4rem', fontWeight: '800', color: '#ffffff', lineHeight: 1 }}>4</div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '1.4rem', fontWeight: '800', color: '#ffffff', lineHeight: 1 }}>1,070</div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '1.4rem', fontWeight: '800', color: '#ffffff', lineHeight: 1 }}>267</div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '1.4rem', fontWeight: '800', color: '#ffffff', lineHeight: 1 }}>88%</div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                            ...
                            <div>
                                <div style={{ fontSize: '1.4rem', fontWeight: '800', color: '#ffffff', lineHeight: 1 }}>12%</div>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))', gap: '3rem', marginBottom: '4rem' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '2rem' }}>
                                <div>
                                    <h3 style={{ margin: 0, color: '#ffffff', fontSize: '0.95rem', fontWeight: '700' }}>Check-In Timeline</h3>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <h3 style={{ margin: '0 0 2rem 0', color: '#ffffff', fontSize: '0.95rem', fontWeight: '700', textAlign: 'center' }}>Session Comparison</h3>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column' }}>
                            <h3 style={{ margin: '0 0 2rem 0', color: '#ffffff', fontSize: '0.95rem', fontWeight: '700', textAlign: 'center' }}>Demographic Split</h3>
                    ...
                    <div style={{ marginTop: '2rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                            <h3 style={{ color: '#ffffff', fontSize: '1.1rem', fontWeight: '700', margin: 0 }}>Session Breakdown</h3>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
