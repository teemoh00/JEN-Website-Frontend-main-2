    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h2 style={{ margin: '0 0 2rem 0', color: '#ffffff', fontSize: '1.25rem', fontWeight: '800' }}>Add Budget Item</h2>
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative', height: '2.5rem', display: 'flex', alignItems: 'center' }}>
                                {isNewCategory ? (
                                    ...
                                    <>
                                        <select style={{
                                            width: '100%', padding: '0 1rem', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '0.5rem', color: '#ffffff', outline: 'none', appearance: 'none', fontSize: '0.9rem', fontWeight: '600', cursor: 'pointer', height: '100%', boxSizing: 'border-box'
                                        }}>
                                            <option value="Miscellaneous" style={{ color: '#ffffff', background: '#1a1a24' }}>Miscellaneous</option>
                                            <option value="Venue" style={{ color: '#ffffff', background: '#1a1a24' }}>Venue</option>
                                            <option value="Catering" style={{ color: '#ffffff', background: '#1a1a24' }}>Catering</option>
                                            <option value="Equipment" style={{ color: '#ffffff', background: '#1a1a24' }}>Equipment</option>
                                            <option value="Marketing" style={{ color: '#ffffff', background: '#1a1a24' }}>Marketing</option>
                                        </select>
