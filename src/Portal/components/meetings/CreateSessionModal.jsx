    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <h2 style={{ margin: '0 0 2rem 0', color: '#ffffff', fontSize: '1.25rem', fontWeight: '800' }}>Add New Session</h2>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="e.g. Opening Worship" style={{
                            width: '100%', padding: '0 1rem', background: 'transparent', border: 'none', color: '#ffffff', outline: 'none', fontSize: '0.9rem'
                        }} />
                    </div>
                            ...
                            <div style={{ position: 'relative', height: '2.5rem', display: 'flex', alignItems: 'center' }}>
                                {isNewDay ? (
                                    <input type="text" placeholder="e.g. Day 4" style={{
                                        width: '100%', padding: '0 1rem', background: 'transparent', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '0.5rem', color: '#ffffff', outline: 'none', fontSize: '0.9rem', height: '100%'
                                    }} />
                                ) : (
                                    <>
                                        <select style={{
                                            width: '100%', padding: '0 1rem', background: 'transparent', border: 'none', color: '#ffffff', outline: 'none', appearance: 'none', fontSize: '0.9rem', fontWeight: '600', cursor: 'pointer', height: '100%'
                                        }}>
                                            <option value="Day 1" style={{ color: '#ffffff', background: '#1a1a24' }}>Day 1</option>
                                            <option value="Day 2" style={{ color: '#ffffff', background: '#1a1a24' }}>Day 2</option>
                                            <option value="Day 3" style={{ color: '#ffffff', background: '#1a1a24' }}>Day 3</option>
                                        </select>
                                ...
                                {isNewType ? (
                                    ...
                                    <>
                                        <select style={{
                                            ...
                                            <option value="Other" style={{ color: '#ffffff', background: '#1a1a24' }}>Other</option>
                                            <option value="Meal" style={{ color: '#ffffff', background: '#1a1a24' }}>Meal</option>
                                            <option value="Prayer" style={{ color: '#ffffff', background: '#1a1a24' }}>Prayer</option>
                                            <option value="Teaching" style={{ color: '#ffffff', background: '#1a1a24' }}>Teaching</option>
                                        </select>
                                        <span style={{ position: 'absolute', right: '1rem', pointerEvents: 'none', color: '#ffffff', fontSize: '0.8rem' }}>▼</span>
                                    </>
                                )}
                        ...
                        <div>
                            ...
                            <div style={{ position: 'relative' }}>
                                <input type="time" defaultValue="09:00" style={{
                                    width: '100%', padding: '0 1rem', background: 'transparent', border: 'none', color: '#ffffff', outline: 'none', fontSize: '0.9rem', fontWeight: '600', fontFamily: 'monospace'
                                }} />
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
                        ...
                        <button onClick={onClose} style={{
                            background: '#a855f7', color: '#ffffff', border: 'none', borderRadius: '0.5rem', padding: '0.6rem 1.25rem', fontSize: '0.9rem', fontWeight: '700', cursor: 'pointer'
                        }}>
                            Add Session
                        </button>
                    </div>
